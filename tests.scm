...
(even? 2034230941823498120)
; expect True

(even? 2304913284019321)
; expect False

'(hi paul denero)
; expect (hi paul denero)

(define (divide-ten x) (/ x 10))
; expect divide-ten
(divide-ten 100)
; expect 10
...
(define (average-three x y z)
  (/ (+ x y z) 3))
; expect average-three
(average-three 2 6 10)
; expect 6

'(9 (2 three . (7 . 9)))
; expect (9 (2 three 7 . 9))
...
(define sign (lambda (x) (if (> x 0) (quote +) (quote -)))) (sign -1)
; expect -
...
'(i love this class)
; expect (i love this class)

'(please give me an A)
; expect (please give me an a)
